 ...
 export const projects : Project[] = [
    {
      ...
      img: 'assets/img/project-images/hp.png',
    ...
    // Kochwelten, photogallerie, TicTacToe, QuizApp etc später raus nehmen
    {
      ...
      img: 'assets/img/project-images/Kochwelt.png',
    ...
    },
    {
      ...
      img: 'assets/img/project-images/fotoalbum.png',
    ...
    // Ende alte Projekte
    {
      ...
      img: 'assets/img/project-images/pokedex2.png',
    ...
    },
    {
      ...
      img: 'assets/img/project-images/join.png',
    ...
    },
    {
      ...
      img: 'assets/img/project-images/rof.png',
    ...
    },
    {
      ...
      img: 'assets/img/project-images/crm.png', //'assets/img/test.png', 
